...
const HomePage = () => {
  ...
  const [visibleCategories, setVisibleCategories] =
    useState(initialVisibleCount); // Initial count
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Find everything you need, neatly organized by category
                </p>
              </div>
              ...
              {category.length > 0 ? (
                <div
                  className="grid   grid-cols-2       
                       sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-3 md:pl-20     gap-5"
                >
                  {category.slice(0, visibleCategories).map((category) => {
                    ...
                    return (
                      <div
                        ...
                        className="relative  max-w-90 bg-red-600 group overflow-hidden rounded-xl cursor-pointer"
                       >
                        {/* Image */}
                        <img
                          src={imageSrc} 
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-3">
                          ...
                          {/* Hover underline */}
                          <span className="mt-3 block h-0.5 w-0 bg-white transition-all duration-300 group-hover:w-10"></span>
                        </div>
                      </div>
                    );
                  })}
                ...
                <div className="text-center text-red-500 py-10">
                  ...
                  <p>Poor network connection. Please reload.</p>
                </div>
              )}
