                  ...
                  >
                    ...
                    <div className="p-4">
                      <div className="w-full flex items-center justify-between">
                        ...
                        >
                          <FaRegHeart className={`${wishlist.includes(product._id)?'text-red-500':'text-gray-700'}`} size={20}  />
                        </button>
                      </div>
                  ...
                  >
                      ...
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                          // className={`h-5 w-5 text-gray-400`}
                           className={`h-5 w-5 ${wishlist.includes(product._id) ? 'text-red-500 fill-red-500' : 'text-gray-400'}`}
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                      >
                    ...
                    <div className="p-2">
                      ...
                      </h3>
                      {
                        ...
                        <span className="text-xs font-medium">{product.averateRating || "N/A"}</span>
